...
存在 `dist/ThesisCraft.v4.0.3.exe` 时使用打包程序；否则使用项目 `.venv` 中的 Python。启动后出现独立的“学研排版”操作窗口，上方显示连接的文档名称；兼容工具栏也会尽可能出现在 Office 的加载项区域。无需到功能区里寻找按钮。
